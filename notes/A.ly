...
QuiSedesAltoNotes = {
  \relative c' {
    ...
    r a2~ %435
    a a4~
    a gis2 a2 r4\fermata \bar "||" %437 finis
  }
}
...
QuoniamAltoNotes = {
  \relative c' {
    \clef treble
    \twotwotime \key d \major \time 2/2 \autoBeamOff \tempoQuoniamB
...
CumSanctoAltoNotes = {
  \relative c' {
    ...
    r1*3/4 r
    r4 a fis? g2 a4 %585
    \tempoCumSanctoAFinis h( e,2) a r4\fermata \bar "||" %586 finis
...
CumSanctoAltoLyrics = \lyricmode {
  ...
  _ _ _ _
  _ _ _ _ %675
  men. Lau -- da -- mus \xE te, be -- ne -- di -- ci -- mus
  te, ad -- o -- ra -- mus te, glo -- ri -- fi -- ca -- mus
  te, in glo -- ri -- a\x De -- i
  Pa -- _ _
  _ _ %680
  \xE tris, a --
  men, a --
