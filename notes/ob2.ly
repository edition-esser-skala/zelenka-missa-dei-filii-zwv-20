...
ChristeOboeII = {
  \relative c' {
    ...
    r1*3/4 r4 r r8 gis\f
    a4 dis e f e e
    d8[ c] h r r4 r1*3/4
    R1.*2 %45
    e2.\ff^\tenuto d8 r r4 r
    a\f a a a r r
    fis'2.\ff^\tenuto e8 r r4 r
    R1.*4 %52
    r1*3/4 r8 g,\fE fis8.( g32 a) fis8.( g32 a)
    r4 \appoggiatura { fis8[ g] } a2 g16 fis e8 h' e,(-. e-. e-.)
    e8 g\p fis8.( g32 a) fis8.( g32 a) r1*3/4 %55
    r h4\f cis dis
    e8. g,16 a4 h e, r r
    R1.
    r1*3/4 h'4\f fis'? e
    fis?8 r r4 r r1*3/4 %60
    R1.
    r4 \tempoChristeB r r r\fermata r r
    \tempoChristeC a,\f a f e e r
    r a\f gis a dis e
    f gis a d,8( c) r4 r %65
    R1.*5 %70
    \time 3/4 R2.
    \time 6/4 R1.
    r1*3/4 \tempoChristeB r
    \tempoChristeC r g!4\f g g
    e8.(\fE f16) g4 g g8 f d4 a'~ %75
    a a a fis8.\fE gis16 a4 a~
    a8 gis \appoggiatura fis e4 gis a dis e
    f e e f e8 d16 c h8 d
