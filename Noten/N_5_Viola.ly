...
% 		\clef treble
		...
		\time 12/4 f8.-!-\critnote c16-! d4-! e-! e \tempoChristeFinis e^\tenuto g a r f h,2\fermata r4 \KyrieDaCapo \bar "||" %83 FINIS
	}
}
...
% 		\clef treble
		...
		g, h, c d g,-\markup { \anmerkung "un poco piano" } g'16 f e8 c
		f f, f' d c f e d %145
		c f e d c f e d
		c f e d c d e c
		g' a h a g a h g
...
% 		\clef treble
		...
		es16([\fE^\markup { \anmerkung "con sordino" } f]) g8 g g f es16 d
		c8 h c h c d~ %255
		d c d~ d c16 d~ d8
		c d c h16([ a)] g8 d'
		g4 r8 es r es
		...
		c g' h, r es( d)
		c es16 f g8 c,4 r8 \bar "||" %403 finis
	}
}
...
% 		\clef treble
		...
		\tempoQuoniamAFinis a4 gis8. gis16 gis8. gis16 <a e a,>2\fermata r4 \bar "||" %437 finis
	}
}
...
% 		\clef treble
		...
		d8 a h a16 g fis8 a, h a16 g
		fis8 d' e cis d a h a16 g
		fis8 d' g a d,4 r \bar "||" %580 finis
	}
}
...
% 		\clef treble
		...
		\tempoCumSanctoAFinis e4 e2\trill d\fermata r4 \bar "||" %586 finis
