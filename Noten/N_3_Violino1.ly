...
ChristeViolinoI = {
	\relative c' {
		...
		\time 12/4 a8.-! c,16-! d4-! e-! a, \tempoChristeFinis r e''~ e8 f dis4. e8 e2\fermata r4 \KyrieDaCapo \bar "||" %83 FINIS
	}
}
...
GloriaViolinoI = {
	\relative c' {
		...
		g''16\fE^\markup { \anmerkung staccato } g, h c d e d e d4-! <g h, d, g,>-!
		r8 e( d c) h4-! <g' h, d, g,>-!
		r8 e( d c) h4-! <g' h, d, g,>-!
		...
		f-\markup{ \anmerkung "piano un poco" } a, f' d c f e d
		...
		g, h, c d g,-\markup{ \anmerkung "piano un poco" } g'16 f e8 c
...
QuiTollisViolinoI = {
	\relative c' {
		...
		g'8\fE^\markup { \anmerkung "con sordino" } c16[ d es d] c h \appoggiatura h8 c4
		...
		c8 es,-! d-! c c'( h)
		g16( es') es8( d) c, c'( h)
		c es,16-! f-! g8-! c,4 r8 \bar "||" %403 finis
	}
}
...
QuiSedesViolinoI = {
	\relative c' {
		...
		\tempoQuoniamAFinis d4 d4.\trill d8 <a' cis, e, a,>2\fermata r4 \bar "||" %437 finis
	}
}
...
QuoniamViolinoI = {
	...
	\relative c' {
		...
		<d fis d'>4-!\fE-\tweak TextScript.X-offset #2 -\tuttiE ^\markup { \anmerkung "staccato" } q-! d16 d e d d d e d %438
		...
		fis'32( e d8.) e32( e fis8.) g,16-! g-! a g g g a g
...
CumSanctoViolinoI = {
	\relative c' {
		...
		\tempoCumSanctoAFinis g4 g4.\trill fis8 fis2\fermata r4 \bar "||" %586 finis
