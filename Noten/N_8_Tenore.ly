...
GloriaTenoreNotes = {
	\relative c' {
		...
		g e e' d c4 h8 h
		h4( a8.) h16 h4 r
		r8 \mvTr e\fE^\tutti dis cis h e16 e dis8 cis16 cis
...
QuiSedesTenoreNotes = {
	\relative c' {
		...
		h e, d' h4. h8 h4 %435
		r a cis d2 e4(
		f) d2 e\fermata r4 \bar "||" %437 finis
	}
}
...
CumSanctoTenoreNotes = {
	\relative c' {
		...
		\tempoCumSanctoAFinis d d( cis) d2\fermata r4 \bar "||" %586 finis
