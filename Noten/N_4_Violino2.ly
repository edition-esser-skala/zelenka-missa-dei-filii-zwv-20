...
ChristeViolinoII = {
	\relative c' {
		...
		\time 12/4 a8.-! c,16-! d4-! e-! a, \tempoChristeFinis c'^\tenuto h a2. gis2\fermata r4 \KyrieDaCapo \bar "||" %83 FINIS
	}
}
...
GloriaViolinoII = {
	\relative c' {
		...
		h'8\fE^\markup { \anmerkung staccato } g16 a h c h c h4 <g' h, d, g,>-!
		r8 c,( h a) g4-! <g' h, d, g,>-!
		r8 c,( h a) g4-! <g' h, d, g,>-!
		...
		<g h, d, g,>4 r8 <fis a, d,> <g h, d, g,>4 r8 <fis a, d,>
		<g h, d, g,>4 r8 <fis a, d,> <g h, d, g,>4 r8 <fis a, d,>
		<g h, d, g,>8 c, a a' g d e d16 c %250
...
CumSanctoViolinoII = {
	\relative c' {
		...
		\tempoCumSanctoAFinis g4 h, cis d2\fermata r4 \bar "||" %586 finis
