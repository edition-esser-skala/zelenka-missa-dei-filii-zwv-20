...
\paper {
	...
	first-page-number = #1 % K: 1   G1: 13   G2-4: 51   G5: 81
	print-first-page-number = ##t
}
...
KyrieDaCapo = { \override Score.RehearsalMark.self-alignment-X = #RIGHT \mark \markup { \right-align \anmerkung "Kyrie da capo" } }
